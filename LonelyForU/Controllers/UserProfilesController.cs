...
namespace LonelyForU.Controllers
{
    ...
    public class UserProfilesController : ControllerBase
    {
        ...
        public UserProfilesController(DatingDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<UserProfile>> PostUserProfile(UserProfile userProfile)
        {
          if (_context.UserProfiles == null)
          {
              return Problem("Entity set 'DatingDbContext.UserProfiles'  is null.");
          }
        ...
        {
            return (_context.UserProfiles?.Any(e => e.ProfileId == id)).GetValueOrDefault();
        }
    }
}
